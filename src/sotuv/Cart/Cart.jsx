  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-4 sm:py-8 px-2 sm:px-4">
      <div className="max-w-7xl mx-auto">
        {orderSuccess ? (
          <div className="max-w-md mx-auto text-center bg-white p-6 sm:p-8 lg:p-12 rounded-xl shadow-lg border border-green-100">
            ...
            <p className="text-gray-600 mb-2">Buyurtma raqamingiz:</p>
            <p className="text-lg font-bold text-red-600 mb-6 bg-red-50 py-2 px-4 rounded-lg inline-block">
              {orderData?.id}
            </p>

            {/* Foydalanuvchi uchun xabarnoma */}
            <p className="text-sm text-gray-400 mb-4 italic">
              10 soniyadan so'ng asosiy sahifaga yo'naltirilasiz...
            </p>

            <Link
              to="/"
              className="inline-block w-full sm:w-auto bg-red-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-red-700 transition-colors"
            >
