              ...
              {filteredProducts.map((product) => (
                ...
                >
                  <div className="aspect-[4/5] rounded-xl overflow-hidden mb-2">
                    <img 
                      src={product.images?.[0]?.image_url || "https://media.licdn.com/dms/image/v2/D5612AQE8NiooxTxA3w/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1695825196046?e=2147483647&v=beta&t=2zU71mKLxGihkNQB5eMDjCgbD7srasN1gyEqowXMGV4"} 
                      alt={product.name}
